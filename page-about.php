...
<section class="about-me">
  <div class="container">
    <div class="row">
      <div class="col-md-7">
        <h2>The journey</h2>
        <p>I'm a full-time and freelance front-end web developer motivated by a passion for coding and WordPress. I offer front-end development, WordPress theme building, and HTML e-mail marketing services.</p>
        <p>My path to become a web developer started off in New York City. I was laid off in 2012 after 10 years of working for Merrill Lynch. I enrolled myself in a front-end web development course at General Assembly, at the urging of my then girlfriend who suggested it might be a good idea to learn a skill that I have interest in instead of going back to the world of finance.</p>
        ...
        <h2>The Code</h2>
        <p>My HTML is valid and optimized for SEO, and I'm experience with front-end frameworks like Bootstrap and Foundation. I use SASS to keep CSS DRY and my style sheets well organized and modular. to keep the large style sheets organized, to keep them DRY (Don't repeat yourself). </p>
        <p>My HTML is validated and search engine optimized, my CSS is organized and uses best practices, and my WordPress sites are easily updatable. Everything is beautifully responsive and works on all devices. Frameworks and code trends are avoided to ensure code is easy to maintain and lasts longer. It’s my job to ensure you never have to deal with ugly old code ever again.</p>
        <h2>The Client</h2>
        <p>I've been in business for myself since 2013, and mostly work with small to mid-size businesses. During the day I work as a web developer for AgencyMSI in downtown Chicago.</p>

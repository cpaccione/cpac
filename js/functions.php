...
function theme_styles() {
	...
	wp_enqueue_style( 'main', get_template_directory_uri() . '/css/style.css', '3.3', 'all' );
}
...
function theme_js() {
	...
	wp_enqueue_script( 'script_js', get_template_directory_uri() . '/js/script.js', array('jquery'), '1.4', true );
}
